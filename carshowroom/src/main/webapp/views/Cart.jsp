...
body {
	background-image: url("https://s-media-cache-ak0.pinimg.com/originals/2a/8e/9e/2a8e9ec554730d31361fd6b1e9fb9f80.jpg");
...
<body>
	...
	<header>
		<center>
		<h1 style="font-family:monotype corsiva;"><img src="http://webneel.com/sites/default/files/images/manual/logo-all/3-best-car-logo-design.gif" height="77" width="77" style="font-family: monotype corsiva;" /><b>carshowroom</b></h1>
	</center>
...
<div > 
					<h3 style="font-family:monotype corsiva;color:gray;font-size: 1.7em;"><b>Items in your cart</b></h3>
					</div>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
      ...
      */
      $scope.removeItemFromCart = function (id) {
         $http['delete']('http://localhost:8080/carshowroom/categoryDropdown/productDisplay/usercart/cart/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8080/carshowroom/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8080/carshowroom/categoryDropdown/productDisplay/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8080/carshowroom/categoryDropdown/productDisplay/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
